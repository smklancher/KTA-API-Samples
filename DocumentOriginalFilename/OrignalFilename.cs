...
namespace KtaCase
{
    public class OriginalFilename
    {
        ...
        public bool DeleteFile(string file, out string errorMessage)
        {
            bool success = true;
        ...
        /// <summary>
        /// Delete the temporary files after they have been emailed.
        /// </summary>
        /// <param name="files">array of file paths to delete</param>
        /// <param name="errorMessages">returns error messages if applicable</param>
        /// <returns>true if an error occurs</returns>
        public bool DeleteFiles(string[] files, out string errorMessages)
        {
            bool success = true;
        ...
        /// <summary>
        /// OPMT can only send email from the file system from the specific tenant's generated documents path.  The email activity
        /// will add that path when trying to get the file, so this function will save to that folder, then return only file names
        /// instead of full paths.  That way the return value can be used directly in the email activity's attachment field.
        /// </summary>
        /// <param name="sessionId"></param>
        /// <param name="folderId"></param>
